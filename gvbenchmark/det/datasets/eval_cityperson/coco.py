...
#  COCO       - COCO api class that loads COCO annotation file and prepare
#               data structures.
...
class COCO:
        ...
        if len(anns) > 0:
            ...
            if 'caption' in anns[0]:
                ...
                for id, ann in enumerate(anns):
                    ...
                    # x1, x2, y1, y2 = [bb[0], bb[1], bb[2], bb[3]]
    ...
    def loadNumpyAnnotations(self, data):
        """Convert result data from a numpy array [Nx7] where each row
        contains.
